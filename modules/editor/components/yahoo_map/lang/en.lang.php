<?php
    /**
     * @file   /modules/editor/components/yahoo_map/lang/en.lang.php
     * @author
     * @brief  editor module > language pack of multimedia_link(Yahoo Map) component
     **/

    $lang->width = "Width";
    $lang->height = "Height";
    $lang->yahoo_map_preview = "Preview";
    $lang->about_width = "Pixel(px)<br />*Enter a Number ONLY";
    $lang->about_height = "Pixel(px)<br />*Enter a Number ONLY";

    // Expressions
    $lang->about_address = "Ex) London, Paris";
    $lang->about_address_use = "Please press [Insert] button. Then, the map would be added to the article.";
