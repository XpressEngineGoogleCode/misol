<?php
    ...
    $lang->width = "寬度";
    $lang->height = "高度";
    $lang->yahoo_map_preview = "預覽";
    $lang->about_width = "像素(px)<br />*只能輸入數字";
    $lang->about_height = "像素(px)<br />*只能輸入數字";

    // Expressions
    $lang->about_address = "例) 倫敦, 巴黎";
    $lang->about_address_use = "請按 [插入] 按鈕。然後地圖將會被新增到文章中。";

    // 錯誤訊息
    $lang->msg_not_exists_addr = "找不到地址";
    $lang->msg_fail_to_socket_open = "無法連結郵政編號伺服器";
